...
import type { LastInsertBookView } from "~/__generated/model/static";

defineProps<{
  books: readonly LastInsertBookView[];
}>();
  ...
  <div class="bg-secondary rounded-xl shadow-sm p-4">
    <div class="flex items-center justify-between mb-4">
      <div class="flex items-center gap-2">
        ...
        <h3 class="font-semibold">新书榜单</h3>
      </div>
    </div>
    <div class="space-y-3">
      <div
      ...
      >
        ...
        <div class="flex-1 min-w-0">
          <p class="text-sm font-medium truncate group-hover:text-purple-600">
            {{ book.bookName }}
          </p>

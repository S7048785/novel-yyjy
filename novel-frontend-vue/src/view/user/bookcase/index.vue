...
import type {BookShelfView} from "@/type/book.ts";
import {getBookShelfAPI} from "@/api/book.ts";

const bookShelf = ref<BookShelfView[]>();
...
<template>
	<div>
		<p class="border-b pb-2 mb-2">
			<span class="text-xl font-bold mr-4">我的书架</span>
